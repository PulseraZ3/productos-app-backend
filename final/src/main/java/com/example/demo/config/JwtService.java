...
public class JwtService implements IJwtService {
    ...
    private static final String SECRET= "mi-clave-super-larga-secreta-123456789";
    ...
    public void generarAutenticacion(Claims claims) {
        List<String> authorities = claims.get("Authorities", 
				List.class);
        UsernamePasswordAuthenticationToken auth = new UsernamePasswordAuthenticationToken(claims.getSubject(), null, authorities.stream().map(SimpleGrantedAuthority::new).toList());
